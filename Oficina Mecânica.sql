...
create table relServicoEstado(
	idServico int,
    idEstadoVeiculo int,
    constraint fk_idServico_Estado foreign key (idServico) references servico(idServico),
...
create table relPecaEstado(
	idPeca int,
    idEstadoVeiculo int,
    constraint fk_idPeca_Estado foreign key (idPeca) references peca(idPeca),
    constraint kf_idEstadoVeiculo_Peca foreign key (idEstadoVeiculo) references estadoVeiculo(idEstadoVeiculo)
);
